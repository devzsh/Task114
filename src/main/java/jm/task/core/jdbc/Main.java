...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        System.out.println("User с именем " + user1.getName() +  " в базу данных");
        userDao.saveUser(user2.getName(), user2.getLastName(), user2.getAge());
        System.out.println("User с именем " + user2.getName() +  " в базу данных");
        userDao.saveUser(user3.getName(), user3.getLastName(), user3.getAge());
        System.out.println("User с именем " + user3.getName() +  " в базу данных");
        userDao.saveUser(user4.getName(), user4.getLastName(), user4.getAge());
        System.out.println("User с именем " + user4.getName() +  " в базу данных");
